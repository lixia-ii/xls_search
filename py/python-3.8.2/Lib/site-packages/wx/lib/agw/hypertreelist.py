...
#                self.ReleaseMouse()
    ...
    def OnlyHideItem(self, item, hide=True):
        item.Hide(hide)
...
_methods = ["GetIndent", "SetIndent", "GetSpacing", "SetSpacing", "GetImageList", "GetStateImageList",
            ...
            "HideItem", "OnlyHideItem", "RefreshTreeItems", "DeleteAllItems", "ItemHasChildren", "ToggleItemSelection", "SetItemType", "GetCurrentItem",
